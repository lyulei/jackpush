...
@section('content')
    ...
    @endif
    <!-- 代码基本信息新增表单 -->
        <form method="post" class="layui-form" action="{{url('CodeInfo/'.$gamenumber)}}">
            ...
            <div class="layui-inline">
                <button class="layui-btn layui-btn-primary">编辑</button> <a href="{{url('CodeInfo/'.$codeid)}}" class="layui-btn">取消</a>
            </div>
        </form>
